...
export const BLOCKS = [
  ...
  { key: 'road_line',  name: 'Road (Lane Line)', category: 'surface', color: 0xd8d2b4, cost: 66,  maintenance: 1.0, solid: true, support: 7, autoZone: 'road' },
  { key: 'path',       name: 'Pedestrian Path',  category: 'surface', color: 0xbfae94, cost: 40,  maintenance: 0.4, solid: true, support: 7, autoZone: 'concourse' },
